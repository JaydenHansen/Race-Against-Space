...
///////// Gloss:
                float4 _Metalic_Gloss_var = tex2D(_Metalic_Gloss,TRANSFORM_TEX(i.uv0, _Metalic_Gloss));
                float gloss = _Metalic_Gloss_var.a;
                float perceptualRoughness = 1.0 - _Metalic_Gloss_var.a;
...
////// Specular:
                ...
                float3 specularColor = _Metalic_Gloss_var.r;
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float3 specColor;
                float4 _Metalic_Gloss_var = tex2D(_Metalic_Gloss,TRANSFORM_TEX(i.uv0, _Metalic_Gloss));
                diffColor = DiffuseAndSpecularFromMetallic( diffColor, _Metalic_Gloss_var.r, specColor, specularMonochrome );
                float roughness = 1.0 - _Metalic_Gloss_var.a;
